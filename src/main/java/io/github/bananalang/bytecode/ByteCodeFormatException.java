...
public class ByteCodeFormatException extends RuntimeException {
     ...
     */
    public ByteCodeFormatException(String message) {
        super(message);
    }
     ...
     * @since  1.4
     */
    public ByteCodeFormatException(String message, Throwable cause) {
        super(message, cause);
    }
     ...
     * @since  1.4
     */
    public ByteCodeFormatException(Throwable cause) {
        super(cause);
    }
     ...
     * @since 1.7
     */
    protected ByteCodeFormatException(String message, Throwable cause,
